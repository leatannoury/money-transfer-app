...
<h1 class="text-text-light dark:text-text-dark text-lg font-bold">Admin Panel</h1>
</div>
<nav class="flex-grow p-4">
<ul class="flex flex-col gap-2">
<li>
<a class="flex items-center gap-3 px-4 py-2.5 rounded-lg bg-primary/20 text-primary" href="{{ route('admin.dashboard') }}">
<span class="material-symbols-outlined">
                                    grid_view
                                </span>
...
<li>
<a class="flex items-center gap-3 px-4 py-2.5 rounded-lg text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors" href="{{route('admin.users')}}">
<span class="material-symbols-outlined">
                                    group
                                </span>
...
<li>
<a class="flex items-center gap-3 px-4 py-2.5 rounded-lg text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors" href="{{route('admin.transactions')}}">
<span class="material-symbols-outlined">
                                    receipt_long
                                </span>
...
<div class="bg-center bg-no-repeat aspect-square bg-cover rounded-full size-10" data-alt="Admin user avatar" style="background-image: url(&quot;https://lh3.googleusercontent.com/aida-public/AB6AXuAZGSG9bWhCPk35zugEcrZd7I-efkeOyQHJVgtgNBX6lD0o-CFXKwYV0O-Ur6LN3t0vsRcDhJRIyA1oNKErzVxx5UxKtFsitEymnShKorJKfkmL2CbpN5n04EAvMJC4JEu9llR87TN4s3iQc37upl-dy2O8IpZcXsI9MiFROUscq7vhKuKvyQX5kkM7k3LnwGfMk0GK28s2zHDDkz4lkHlXxWIbaL3ojnc9tecGIsQkJ5nYnnqPcQc1xTlOCF1JX2Qj506mRRnWAtt6&quot;);"></div>
<div class="flex flex-col">
<h2 class="text-text-light dark:text-text-dark text-sm font-semibold">Admin User</h2>
<p class="text-gray-500 dark:text-gray-400 text-xs">admin@example.com</p>
</div>
</div>
</div>
</aside>
